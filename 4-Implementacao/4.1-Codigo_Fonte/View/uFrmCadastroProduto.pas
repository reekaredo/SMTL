           ...
           if self.edt_precoMin.Text = '' then
            self.edt_precoMin.Text := self.edt_preco.Text;
                ...
                if (self.edt_nome.Text = '') then
                    ...
                    begin
                      ShowMessage('Campo unidade é obrigatório!');
                      self.edt_unidade.SetFocus;
                    end
                else if (self.edt_referencia.Text = '') then
                    begin
                      ShowMessage('Campo referência é obrigatório!');
                      self.edt_unidade.SetFocus;
                    end
                    ...
                    begin
                      ShowMessage('Por favor, digite um número inteiro no campo "Unidade" ');
                      Self.edt_unidade.SetFocus;
                    end
                    ...
                    begin
                      ShowMessage('Valor digitado no preço mínimo é inválido!' + #13 + 'Formato: 0,00 ou números inteiros');
                      self.edt_precoMin.SetFocus;
                    end

                 else if (verificaReal(self.edt2.Text) = False) then
                    begin
                      ShowMessage('Valor digitado na comissão é inválido!' + #13 + 'Formato: 0,00 ou números inteiros');
                      self.edt2.SetFocus;
                    end
