...
-- Script date 08/08/2016 16:33:35
...
CREATE TABLE pedidos (
  ...
  ped_cod_venda VARCHAR(15) DEFAULT NULL,
  ped_data DATE DEFAULT NULL,
  ped_cliente INT(11) DEFAULT NULL,
  ped_vendedor INT(11) DEFAULT NULL,
  ped_forma INT(11) DEFAULT NULL,
  ped_valor DOUBLE(15, 2) NOT NULL DEFAULT 0.00,
  PRIMARY KEY (ped_id),
  ...
  CONSTRAINT FK_pedidos_forma_forma_id FOREIGN KEY (ped_forma)
    REFERENCES forma(forma_id) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT FK_pedidos_usuarios_user_id FOREIGN KEY (ped_vendedor)
...
-- Table vendas.transportadoras does not contain any data (it is empty)
...
-- Table vendas.pedidos does not contain any data (it is empty)
